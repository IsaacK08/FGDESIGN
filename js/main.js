...
/*MODAL PORTFOLIO*/
document.querySelectorAll(".swiper-wrapper img").forEach(el=>{
...
consoleText(['Creamos tu identidad', 'Diseñamos tu Web','Creamos tu logo', 'Creamos contenido digital', 'Creamos tu historia'], 'text',['','','']);
